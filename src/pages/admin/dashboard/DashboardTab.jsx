...
import { MdOutlineProductionQuantityLimits, MdProductionQuantityLimits } from 'react-icons/md'
    ...
    <div className="relative overflow-x-auto">
      <table className="w-full text-sm text-left text-gray-500 dark-text-gray-400  ">
        ...
        {product.map((item, index) => {
          const { title, price, imageUrl, category, description, date, quantities } = item;
          return (
            <tbody className='' key={index}>
              <tr className="bg-gray-50 border-b  dark-border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
                ...
                <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                  S:{product[index].quantities.S}<br></br>
                  M:{product[index].quantities.M}<br></br>
                  L:{product[index].quantities.L}<br></br>
                 XL:{product[index].quantities.XL}<br></br>
                 XXL:{product[index].quantities.XXL}<br></br>
                    ...
                    <div className="flex gap-2 cursor-pointer text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                      <div onClick={() => deleteProduct(item)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107.letal: 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H8.25a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0" />
                        </svg>
                      </div>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                ...
                                {order.map((allorder,index)=>{
                                    ...
                                    {allorder.cartItems.map((item,index)=>{
                                        console.log("----____----",allorder) 
                                        const {title,description,category,imageUrl,price,size,quantity,userName,userNumber} = item;
                                        return(
                                            <tbody>
                                        <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                            <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                            ...
                                            <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
                                <select
                                    value={allorder.orderStatus}
                                    onChange={(e) => handleOrderStatusChange(allorder, item, e.target.value)}
                                >
                            ...
                            <div className="relative overflow-x-auto mb-10">
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                   ...
                                   {user.map((item,index)=>{
                                    ...
                                    let date = new Date(time.seconds*1000).toLocaleString('en-GB',{timeZone:'UTC'})
                                    return(
                                        <tbody>
                                        <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                            <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
